...
public class Eksempel2_3og5 {
    ...
    public static void doConditionally(List<Person> liste, Predicate<Person> pred, Consumer<Person> cons) {
    ...
    public static void main(String[] args) {
        ...
        doConditionally(people, x -> x.getAge() > 50, x -> System.out.println(x.getAge()));
    }
