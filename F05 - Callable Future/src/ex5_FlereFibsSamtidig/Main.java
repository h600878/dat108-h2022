...
public class Main {
    ...
    public static void main(String... kommandolinjeargumenter) throws InterruptedException, ExecutionException {
        ...
        while (!(fib44.isDone() && fib30.isDone() && fib42.isDone() && fib10.isDone() && fib44endaEnGang.isDone())) { // BUSY WAIT
